		...
		<div id="login_form">
			 ...
			 <div id="login2">
				<div id="id_input_button">
					<fieldset>
                        <span>이름:</span><input type="text" name="name" class="find_input find_name">
                        <span>아이디:</span><input type="text" name="id" class="find_input find_id">
                        <div class="telBox">
